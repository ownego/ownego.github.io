export default {
  loading: {
    desktop: '<strong>Hint:</strong> You can use arrow keys to navigate our site',
    mobile: 'We always try to improve<br/>user experience'
  },
  ...
  screen3: {
    ...
    msgSub: 'Caution*: We will reply to you as soon as you send your message. Please check your inbox for an email from us.',

    msgSuccess: 'Your message has been flown to us! We will reply your message ASAP.',

    errorNameRequired: 'Oops, could you let us know your name?',
    errorEmailRequired: 'We need your email to reply, we prefer dialogue to monologue :)',
    errorEmailInvalid: 'Sike, that\'s the wrong email!',
    errorMessageRequired: 'Don\'t be shy! Tell us anything that is bothering you.',
    errorResponse: 'Oops, sorry. Something went wrong when we try to receive your message. Could you try again later or contact us via contact@ownego.com?'
  }
}
